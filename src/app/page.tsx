  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-sm font-medium mb-6">
              ...
              v0.1.0 — Open Source Desktop Translator
            </div>
            ...
            <p className="mt-6 text-lg sm:text-xl text-slate-500 leading-relaxed max-w-2xl mx-auto">
              TransLite is a lightweight desktop translation app that combines
              local offline models with powerful online LLM providers. Switch
              between providers instantly with a global hotkey.
            </p>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-lg bg-white">
              ...
              <div className="p-4 border-t border-slate-100">
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  Fast, side-by-side translation interface
                </p>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-lg bg-white">
      ...
      <section className="py-16 sm:py-20 bg-slate-50/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="section-title">Multi-Provider Support</h2>
            <p className="section-subtitle">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <div className="rounded-3xl bg-linear-to-br from-indigo-600 via-indigo-700 to-violet-700 p-8 sm:p-12 lg:p-16 shadow-2xl shadow-indigo-500/20">
            ...
            <p className="mt-4 text-indigo-200 text-lg max-w-xl mx-auto">
              Download TransLite today and experience fast, privacy-focused
