      ...
      <section className="py-16 sm:py-20 bg-slate-50/50 border-b border-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900">
            Download <span className="gradient-text">TransLite</span>
          </h1>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <div className="p-4 rounded-xl bg-amber-50 border border-amber-100 flex items-start gap-3">
            ...
            <div className="text-sm text-amber-800">
              <strong>Note:</strong> TransLite is in active development (v0.1.0).
              Download links will be available once the first release is published.
              For now, you can build from source on GitHub.
            </div>
          </div>
        </div>
      </section>
