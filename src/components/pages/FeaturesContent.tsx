  ...
  return (
    <>
      ...
      <section className="py-16 sm:py-20 bg-slate-50/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="section-title">{t.features.diffTitle}</h2>
            <p className="section-subtitle">{t.features.diffSubtitle}</p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-10">
              ...
              <div className="md:col-span-3 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                  ...
                  <span className="text-sm text-slate-600">
                    {t.features.shortcut.windowOpens}
                  </span>
                </div>
            ...
            <div className="grid md:grid-cols-5 gap-8 items-start">
              <div className="md:col-span-2">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">
                  {t.features.localModel.title}
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  {t.features.localModel.desc}
                </p>
              </div>
              <div className="md:col-span-3 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-700">
                      {t.features.localModel.defaultModel}{" "}
                      <code className="px-1.5 py-0.5 rounded bg-slate-100 text-xs font-mono">onnx-community/HY-MT1.5-1.8B-ONNX</code>
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className="text-sm text-slate-700">
                      {t.features.localModel.customDirs}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500" />
                    <span className="text-sm text-slate-700">
                      {t.features.localModel.downloadMgmt}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-5 gap-8 items-start">
              <div className="md:col-span-2">
                <div className="inline-flex p-3 rounded-xl bg-lime-50 text-lime-600 mb-3">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  {t.features.usage.desc}
                </p>
              </div>
              <div className="md:col-span-3 p-6 rounded-2xl bg-white border border-slate-100 shadow-sm">
                <div className="space-y-3">
                  {t.features.usage.bullets.map((item) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="section-title">{t.features.supportedTitle}</h2>
            <p className="section-subtitle">{t.features.supportedSubtitle}</p>
          </div>
          <ProviderCarousel />
        </div>
      </section>
